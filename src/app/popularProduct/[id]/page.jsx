        ...
        <>
            ...
            <div className="w-full relative min-h-screen max-h-fit border border-red-600 overflow-y-auto p-6">
                <div className="flex flex-col gap-4 mb-[150px] ">
                    ...
                    <Reviews productId={productId} reviews={product?.reviews} collectionString={"PopularProducts"}/>
                </div>
                {product?.qty !== 0 && (<AddToCartBtn productID={productId} qty={product?.qty} price={product?.price} collectionString={"PopularProducts"}/>)}
            </div>
        </>
    );
}
