...
const page = () => {
  ...
  const setUserIdDatas = useSelector((state) => state.user.userID);
...
const dispatch = useDispatch()
  ...
  async function fetchUser(userID) {
    try {
      ...
      // Set initial data
      setFetchedUserData(fetchedUserData ? fetchedUserData.profilePicture || "" : "");
  ...
  useEffect(() => { 
    console.log("setUserIdData ", setUserIdDatas)
    },[])
  return (
    ...
    <div className='flex flex-col border border-black  min-h-screen max-h-fit h-full  w-full '>
        <div id='first' className="w-full h-fit flex flex-col gap-4 bg-white p-24 px-5   md:items-center md:constant-spacing-md md:px-48">
        ...
        <div id='second' className="flex flex-col  bg-[#695acde4] p-10 px-5 mb-7  md:px-48">
        ...
        <div id='third' className="flex flex-col  gap-14 constant-spacing p-4  text-[#695acde4] w-[95%] md:w-[85%]  mx-auto">

          <div className="flex flex-col gap-4  w-full md:flex-row md:gap-8  md:items-center md:justify-between ">
          <Image src={phoneImg} className='rounded-3xl w-full aspect-square grayscale-image object-cover  md:max-w-sm' alt='mobile-phone' />
        ...
        <div id="fourth" className='constant-spacing p-4 md:constant-spacing-md bg-[#695acde4] text-white'>
        <div id="title" className='text-center mb-10'>
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row ">
            ...
            <h1 className="font-semibold text-[2rem] leading-[2.55rem] mb-[0.1rem] text-white md:text-base">Peter Larson</h1>
            ...
            <h1 className="font-semibold text-[2rem] leading-[2.55rem] mb-[0.05rem]  text-white md:text-base">Samantha Brown</h1>
            ...
            <h1 className="font-semibold text-[2rem] leading-[2.55rem] mb-[0.15rem]  text-white md:text-base">Jonathan Hill</h1>
            ...
            <h1 className="font-semibold text-[2rem] leading-[2.85rem] mb-[0.15rem]  text-white  md:text-base">Jenny Smith</h1>
            <span className='font-regular text-lg  text-white'>Marketing Manager</span>
          </div>
        </div>
      </div>
        <div id="fifth" className='flex flex-col gap-4 items-center text-center constant-spacing p-4 md:constant-spacing-md md:px-48'>
        ...
        <div className="">
          ...
          <Link href={`/signup`} className='flex-1'>
            ...
            <button onClick={() => checkIfUserIsloggedIn(userID)} className="rounded-xl flex-1  border-none p-[0.65rem] text-xl font-semibold bg-[#695acde4] text-white w-full">
            Sign In
          </button>
        </div>
      </div>
