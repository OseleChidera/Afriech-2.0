...
const SearchBar = ({ search }) => {
  ...
  return (
      <div className="max-w-md w-4/6 mx-auto flex items-center gap-2 backdrop:relative p-2 py-1 pr-0 border border-black rounded-[0.25rem]">
          ...
          {(isSearchClicked)? (<div className=" w-fit aspect-sqiare right-2  p-2 border border-black rounded-[0.25rem]" onClick={() => clearSearchbarInput() }>
              <Image src={cancel2} width={20}/>
          </div>) 
          :
